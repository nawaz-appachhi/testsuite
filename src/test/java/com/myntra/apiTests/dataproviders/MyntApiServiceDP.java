 ...
 *
 */
public class MyntApiServiceDP extends CommonUtils implements IDPServiceConstants
{
	static Logger log = Logger.getLogger(MyntApiServiceDP.class);
	String environment;
	
	public MyntApiServiceDP()
	{
