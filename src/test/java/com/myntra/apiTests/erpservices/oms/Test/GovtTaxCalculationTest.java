...
public class GovtTaxCalculationTest extends BaseTest{
...
*/
	...
	public void validateGovtTaxableAmountAndGovtTaxRateWithAndWihoutShippingCharge(String TestScenario,String sku,Double TaxRate) throws Exception{
		...
		imsServiceHelper.updateInventoryForSeller(new String[] {sku+":"+OMSTCConstants.WareHouseIds.warehouseId36_BW+":10000:0:"+vectorSellerID},supplyTypeOnHand);
	...
	public double getTaxableAmountForDiscountLessThan20(Double mrpTotal, Double additionalCharge,Double discount,Double taxrate){
		
		return (mrpTotal + additionalCharge -discount)*100.0/(100.0+taxrate);
		
	}

	public  double getTaxableAmountForDiscountGreaterThan20(double mrpTotal, double additionalCharge,double discount,double taxrate){
