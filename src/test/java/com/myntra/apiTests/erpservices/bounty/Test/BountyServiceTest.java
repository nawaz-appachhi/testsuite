 ...
 *         testcases.
 */
public class BountyServiceTest extends BaseTest {

	private static Logger log = Logger.getLogger(BountyServiceTest.class);
	...
	public void beforeClass() throws SQLException, IOException, JAXBException {
		...
		bountyServiceHelper.createNewCoupon(uidx, "bounty001", 20);
	...
	public void bountyServiceCreateOrderInvalidPPSID() throws IOException, JAXBException {
		...
		OrderResponse orderResponse = bountyServiceHelper.createOrder((CartEntry) orderEntry.get("cart"), null, login,
	...
	public void bountyServiceCreateOrderInvalidCart() throws IOException, JAXBException {
		...
		OrderResponse orderResponse = bountyServiceHelper.createOrder(null, BountyTestcasesConstants.BountyServiceTest.PASSWORD, login, "" + orderEntry.get("xid"),
	...
	public void bountyServiceCreateOrderBlankSession() throws IOException, JAXBException {
		...
		OrderResponse orderResponse = bountyServiceHelper.createOrder((CartEntry) orderEntry.get("cart"), BountyTestcasesConstants.BountyServiceTest.PASSWORD,
	...
	public void bountyServiceCreateOrder() throws IOException, JAXBException {
		...
		HashMap<String, Object> orderEntry = bountyServiceHelper.getCreateOrderEntry(login, BountyTestcasesConstants.BountyServiceTest.PASSWORD, skuId1, "ADD", "",
				"200", "50", "");
		OrderResponse orderResponse = bountyServiceHelper.createOrder((CartEntry) orderEntry.get("cart"), "12345",
		...
		HashMap<String, Object> orderEntry2 = bountyServiceHelper.getxCartOrderTableDBEntry(orderNumber);
	...
	public void bountyQueueOrderSuccess() throws IOException, JAXBException {
		...
		HashMap<String, Object> orderEntry = bountyServiceHelper.getCreateOrderEntry(login_notify,password_notify, skuId1, "ADD", "",
				"200", "50", "");
		OrderResponse orderResponse = bountyServiceHelper.createOrder((CartEntry) orderEntry.get("cart"), "12345",
				login, "" + orderEntry.get("xid"), "0", "0", "0.0", BountyTestcasesConstants.Pincodes.PINCODE_560068, "responsive", "DEFAULT", "on");
		OrderCreationResponse orderQueueResponse = bountyServiceHelper.queueOrder(
	...
	public void queueAnAlreadyQueuedOrder(String storeOrderId, String sessionID, String login, String cartContext,
		...
		OrderCreationResponse orderQueueResponse = bountyServiceHelper.queueOrder(storeOrderId, sessionID, login,
	...
	public void queueAnOrderWhenInventoryIsNotAvailable() throws IOException, JAXBException {
		...
		HashMap<String, Object> orderEntry1 = bountyServiceHelper.getCreateOrderEntry(login, BountyTestcasesConstants.BountyServiceTest.PASSWORD, skuId1, "ADD",
				"", "200", "50", "");
		OrderResponse orderResponse1 = bountyServiceHelper.createOrder((CartEntry) orderEntry1.get("cart"), "12345",
	...
	public void confirmOrderSuccess() throws IOException, JAXBException {
		...
		HashMap<String, Object> orderEntry1 = bountyServiceHelper.getCreateOrderEntry(login_notify,password_notify, skuId1, "ADD",
				"", "200", "50", "");
		OrderResponse orderResponse1 = bountyServiceHelper.createOrder((CartEntry) orderEntry1.get("cart"), "12345",
				login, "" + orderEntry1.get("xid"), "0", "0", "0.0", BountyTestcasesConstants.Pincodes.PINCODE_560068, "responsive", "DEFAULT", "on");
		String orderID = orderResponse1.getData().get(0).getStoreOrderId();
		OrderCreationResponse orderQueueResponse = bountyServiceHelper.queueOrder(orderID, "" + orderEntry1.get("xid"),
				login, "DEFAULT", "SUCCESS", true);
		Assert.assertEquals(orderQueueResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);

		OrderCreationResponse orderConfirmationResponse = bountyServiceHelper.confirmOnHoldOrder(orderID, "SUCCESS",
	...
	public void confirmAnAlreadyConfirmedOrder(String storeOrderID, String paymentStatus, String ppsID, boolean status)
		...
		OrderCreationResponse orderConfirmationResponse = bountyServiceHelper.confirmOnHoldOrder(storeOrderID, paymentStatus,
				ppsID, status);
	...
	public void declineOrderSuccess(String storeOrderID, String login, String sessionID, String cartContext,
		...
		OrderCreationResponse orderDeclineResponse = bountyServiceHelper.declineOrder(storeOrderID, login, sessionID,
	...
	public void OrderQueueOnHold5FromPPStatus() throws IOException, JAXBException {
		...
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderId).get("status"), "PP");
		OrderCreationResponse orderQueueResponse = bountyServiceHelper.putOrderInHold(storeOrderId, "FAILURE");
		Assert.assertEquals(orderQueueResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderId).get("on_hold_reason_id_fk"), 5);
	...
	public void declineOrderSuccessFromPPStatus(String storeOrderID, String login, String sessionID, String cartContext,
		...
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusCode(), 1004);
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusMessage(), "Order updated successfully");
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderID).get("status"), "D");
	...
	public void declineOrderSuccessFromPVStatus(String storeOrderID, String login, String sessionID, String cartContext,
		...
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderID).get("status"), "PV");
		OrderCreationResponse orderDeclineResponse = bountyServiceHelper.declineOrder(storeOrderID, login, sessionID,
				cartContext, paymentStatus, declineReasonID, putOnHold);
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusCode(), 1004);
	...
	public void declineOrderSuccessFromPVToQOnHold39Status(String storeOrderId, String login, String sessionID,
		...
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderId).get("status"), "Q");
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderId).get("on_hold_reason_id_fk"), 39);
		OrderCreationResponse orderDeclineResponse = bountyServiceHelper.declineOrder(storeOrderId, login, sessionID,
				cartContext, paymentStatus, declineReasonID, putOnHold);
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusCode(), 1004);
	...
	public void OrderQueueOnHold5FromPVStatus() throws IOException, JAXBException {
		...
		String storeOrderId = orderResponse1.getData().get(0).getStoreOrderId();
		Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderId).get("status"), "PV");
		OrderCreationResponse orderQueueResponse = bountyServiceHelper.putOrderInHold(storeOrderId, "SUCCESS");
		Assert.assertEquals(orderQueueResponse.getStatus().getStatusType(), StatusResponse.Type.ERROR);
	}
	...
	public void declineOrderShouldFreeUpBountyInventory() throws IOException, JAXBException, SQLException {
		...
		OrderResponse orderResponse1 = bountyServiceHelper.createOrder((CartEntry) orderEntry1.get("cart"), "12345",
				login, "" + orderEntry1.get("xid"), "0", "0", "0.0", BountyTestcasesConstants.Pincodes.PINCODE_560068, "responsive", "DEFAULT", "on");
		String storeOrderId = orderResponse1.getData().get(0).getStoreOrderId();
		OrderCreationResponse orderQueueResponse = bountyServiceHelper.queueOrder(storeOrderId, "" + orderEntry1.get("xid"),
				login, "DEFAULT", "SUCCESS", true);
		Assert.assertEquals(orderQueueResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
		...
		OrderCreationResponse orderDeclineResponse = bountyServiceHelper.declineOrder(storeOrderId, login,
	...
	public void declineOrderShouldUnBlockTheCouponUsage() throws IOException, JAXBException, SQLException, InvalidSyntaxException {
		...
		HashMap<String, Object> orderEntry1 = bountyServiceHelper.getCreateOrderEntryWithCoupon(login, BountyTestcasesConstants.BountyServiceTest.PASSWORD, skuId1,
		...
		OrderCreationResponse orderDeclineResponse = bountyServiceHelper.declineOrder(storeOrderId, login, "", "DEFAULT",
				"SUCCESS", 2, false);
		Assert.assertEquals(orderDeclineResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
	...
	public void orderCreationShouldFailIfTheIfTheOrderValueIsLessThanCODMinValue_OnlyCOD(CartEntry cartEntry,
		...
		OrderResponse orderCreationResponse = bountyServiceHelper.createOrder(cartEntry, ppsID, login, sessionId,
	...
	public void orderCreationShouldFailIfTheOrderValueIsMoreThanCODMaxValue_CBLPCOD(CartEntry cartEntry, String ppsID,
		...
		OrderResponse orderResponse = bountyServiceHelper.createOrder(cartEntry, ppsID, login, sessionId, binNumber,
	...
	public void verifyMultipleItemAreAvailableTryAndBuyAndTnbFlagShouldAvailableAtItemLevelFromCart() throws Exception {
		...
		for (String skuAndQuantity : skuId) {
			...
			List SelectedRecodes = bountyServiceHelper.getxCartOrderDetailsTableDBEntry(storeOrderID, query);
	...
	public void verifyTheIsTryAndBuyFlagInXCartOrderDetailsTableOneIsTryAndBuyAndOneIsNonTryAndBuyForOrder()
		...
		HashMap<String, Object> orderEntry1 = bountyServiceHelper.getCreateOrderEntry(login, BountyTestcasesConstants.BountyServiceTest.PASSWORD, skuId, "ADD",
				"", "200", "50", "");
		CartEntry cartEntry = bountyServiceHelper.setTryAndBuyInCart(hm,(CartEntry) orderEntry1.get("cart"));
		OrderResponse orderResponse1 = bountyServiceHelper.createOrder(cartEntry, "12345",
				login, "" + orderEntry1.get("xid"), "0", "0", "0.0", BountyTestcasesConstants.Pincodes.PINCODE_560068, "responsive", "DEFAULT", "on");
		String storeOrderID = orderResponse1.getData().get(0).getStoreOrderId();
	...
	public void verifyTheIsTryAndBuyFlagInXcartdOrderDetailsTabelIsTryAndBuyFlagForOrder() throws Exception {
		...
		for (String skuAndQuantity : skuId) {
			String[] skuAndQuantitySplit = skuAndQuantity.split(":");
			String sku = skuAndQuantitySplit[0].trim();
			List SelectedRecodes = bountyServiceHelper.getxCartOrderDetailsTableDBEntry(storeOrderID);
	...
	public void verifyAdressSwitchToDefaultAddressIfFetchThroughAddressIDFailedAndFGIsOn() throws Exception {
		...
		HashMap<String, Object> orderEntry1 = bountyServiceHelper.getCreateOrderEntryWithCoupon(login, BountyTestcasesConstants.BountyServiceTest.PASSWORD, skuID,
	...
	public void verifyAddressShouldBeStoredInBounty() throws Exception {
		...
		HashMap listOrder = bountyServiceHelper.getxCartOrderTableDBEntry(orderEntry.getStoreOrderId());
	...
	public void verifyDBDetailsForNormalOrderWithCoupon() throws Exception {
		...
		HashMap<String, Object> orderEntry = bountyServiceHelper.getCreateOrderEntryWithCoupon(login, BountyTestcasesConstants.BountyServiceTest.PASSWORD, skuId1,
				"ADD", "bounty001", false, false, false);
		OrderResponse orderResponse = bountyServiceHelper.createOrder((CartEntry) orderEntry.get("cart"), "12345",
				login, "" + orderEntry.get("xid"), "0", "0", "0.0", BountyTestcasesConstants.Pincodes.PINCODE_560068, "responsive", "DEFAULT", "on");
		Assert.assertEquals(orderResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
		...
		HashMap<String, Object> hashmapOrderDetail = bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderId);
		...
		totalLines  = bountyServiceHelper.getxCartOrderDetailsTableDBEntry(storeOrderId);
	...
	public void bountyServiceCreateOrderBlankSupplyType() throws IOException, JAXBException {
		...
		HashMap<String, Object> orderEntry = bountyServiceHelper.getCreateOrderEntry(login,
		...
		OrderResponse orderResponse = bountyServiceHelper.createOrder((CartEntry) orderEntry.get("cart"),
	...
	public void declineOrderSuccessFromPPStatusAndSendNotificationAndSMS() throws IOException, JAXBException, ManagerException {
        ...
        HashMap<String, Object> orderEntry1 = bountyServiceHelper.getCreateOrderEntry(login, password, skuId1, "ADD","", "200", "50", "");
		...
		//Assert.assertEquals(bountyServiceHelper.getxCartOrderTableDBEntry(storeOrderID).get("status"), "PP");
		OrderCreationResponse orderDeclineResponse = bountyServiceHelper.declineOrder(storeOrderID, login, ""+orderEntry1.get("xid"),
