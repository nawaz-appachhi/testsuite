...
public class PPSTestDPV2 {
    ...
    public static Object[][] formParametersOnline(ITestContext testContext)
    {
        ...
        // Credit/Debit + Loyalty Point + Mynt + GiftWrap + TryNBuy + AutoGC => Cancel
        ...
        // Credit/Debit + Loyalty Point + Mynt + GiftWrap + TryNBuy + AutoGC => Return
        String[] arr36= {"TC36 : Credit/Debit + Loyalty Point + Mynt + AutoGC + GiftWrap + TryNBuy=> Return",
                "automationtest@myntra.com","123456", "creditcard","true","false","false","false", "true","true","true","true","false","true","false"};

        // COD + Loyalty Point + Mynt + ManualGC + TryNBuy=> Return
        String[] arr37= {"TC37 : COD + Loyalty Point + Mynt + ManualGC => Return",
                "manualgctest@myntra.com","123456", "cod","false","false","true","false", "true","true","false","false","false","true","false"};

        // COD + Loyalty Point + Mynt + AutoGC + TryNBuy=> Return
        String[] arr38= {"TC38 : COD + Loyalty Point + Mynt + AutoGC => Return",
                "automationtest@myntra.com","123456", "cod","true","false","false","false", "true","true","false","false","false","true","false"};
		...
		/*Object[][] dataSet = new Object[][] { arr1,arr7,arr2,arr8,arr3,arr9,arr6,arr10,arr5,arr11,arr4,arr12,
			arr13,arr14,arr15,arr16,arr17,arr18,arr19,arr20,arr21,arr22,arr23,arr24,arr25,arr26,arr27,arr28,
				arr29,arr30, arr31, arr32, arr33, arr34, arr35, arr36, arr37, arr38};*/
        //Object[][] dataSet = new Object[][] {arr28, arr36, arr37};
        Object[][] dataSet = new Object[][] {arr38};
