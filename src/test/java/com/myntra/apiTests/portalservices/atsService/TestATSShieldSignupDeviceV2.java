...
public class TestATSShieldSignupDeviceV2 extends BaseTest implements ATSConstants {
	...
	public static void verifyCreatedAccountActive()
	...
	public void verifyBlackListedStatus()
			throws JsonParseException, JsonMappingException, IOException, InterruptedException {
	...
	public void verifyAllRTOuserCreatewithLabel4() throws IOException, InterruptedException {
		for (int i = 1; i <= 14; i++) {
			String uidx = ideaApiHelper.getUIDXForLoginViaEmail("myntra",
					signupPrefix + String.valueOf(i) + "@myntra.com");
			atsHelperV2.postATSUserDetails(uidx, "1", false, withTenentId);
		}
