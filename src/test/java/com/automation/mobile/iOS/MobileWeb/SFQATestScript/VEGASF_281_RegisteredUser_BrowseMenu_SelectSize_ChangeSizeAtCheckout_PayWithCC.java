...
public class VEGASF_281_RegisteredUser_BrowseMenu_SelectSize_ChangeSizeAtCheckout_PayWithCC extends BaseIOSTest{
	...
	public void LoginWithEmail() throws InterruptedException, InvalidFileFormatException, IOException	{
		...
		System.out.println("=====================VEGASF_281_START=====================");
...
//		objPDPageObject.clickFirstProductSearchResult();
	...
	@Test(priority = 7)
	public void SlectSizeAndQuantity() throws InterruptedException{
		Reporter.log("SlectSizeAndQuantity test case started successfully");
		System.out.println("SlectSizeAndQuantity!");
...
@AfterTest
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_281_END=====================");
	}
