...
/*
 * 
 * Shopper: Google registered user - Login Home Page Search (by clicking banner
 * or nested banner on Home Page) Filter Products Add to bag View Size Chart
 * Contact Us Buy One get One View Details Payment : Online + LP
 */
...
public class VEGASF_406_Google_User_Filter_BOGO_ViewDetails_CoD extends BaseIOSTest{
	...
	public void LoginWithGoogle() throws InterruptedException, InvalidFileFormatException, IOException {
		...
		System.out.println("=====================VEGASF_406_START=====================");
	...
	@Test(priority = 6)
	public void CheckSizeChart_Link() throws InterruptedException {
		Reporter.log("CheckSizeChart_Link test case started successfully");
	...
	@Test(priority =10)
	public void PaymentWithOnline_LP() throws InterruptedException {
		Reporter.log("PaymentWithOnline_LP test case started successfully");
		System.out.println("Payment With Online_LP!");
	...
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_406_END=====================");
	}
