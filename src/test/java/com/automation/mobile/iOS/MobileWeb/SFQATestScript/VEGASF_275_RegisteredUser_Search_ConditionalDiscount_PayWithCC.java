...
public class VEGASF_275_RegisteredUser_Search_ConditionalDiscount_PayWithCC extends BaseIOSTest{
	...
	public void LoginWithEmail() throws InterruptedException, InvalidFileFormatException, IOException	{
		...
		System.out.println("=====================VEGASF_275_START=====================");
...
//		objBagPageObjects.clickOnApplyButton();
	...
	public void PaymentWithCreditDebitCard() throws InterruptedException	{
		...
		System.out.println("PaymentWithCredit/DebitCard!");
...
@AfterTest
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_275_END=====================");
	}
