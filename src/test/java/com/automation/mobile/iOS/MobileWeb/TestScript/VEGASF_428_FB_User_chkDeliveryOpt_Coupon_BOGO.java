...
public class VEGASF_428_FB_User_chkDeliveryOpt_Coupon_BOGO extends BaseIOSTest{
	...
	public void LoginInMyntra() throws InterruptedException, InvalidFileFormatException, IOException	{
		...
		System.out.println("=====================VEGASF_428_START=====================");
...
//		Reporter.log("SortByDiscount test case started successfully");
...
@AfterTest
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_428_END=====================");
	}
