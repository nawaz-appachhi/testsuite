...
public class VEGASF_276_RegisteredUser_SizeSensitive_BOGO_PayWithCoD extends BaseIOSTest{
	...
	String testName = "VEGASF_276";

	@Test(priority = 1)
	public void LoginWithEmial() throws InterruptedException, InvalidFileFormatException, IOException	{
		Reporter.log("LoginWithEmail test case started successfully");
		System.out.println("=====================VEGASF_276_START=====================");
	...
	//		objPDPageObject.clickMyntraLogo();
	//		objHomePageObjects.clickOnHamburgerButton();
