...
public class VEGASF_283_RegisteredUser_BrowseMenu_ShowMore_AddMoreFromWishList_PayWithCoD extends BaseIOSTest{
	...
	public void LoginWithEmail() throws InterruptedException, InvalidFileFormatException, IOException	{
		...
		System.out.println("=====================VEGASF_283_START=====================");
...
//	}
	...
	public void AddFromWishlist() throws InterruptedException {
		Reporter.log("AddFromWishlist test case started successfully");
		System.out.println("AddFromWishlist!");
...
@AfterTest
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_283_END=====================");
	}
