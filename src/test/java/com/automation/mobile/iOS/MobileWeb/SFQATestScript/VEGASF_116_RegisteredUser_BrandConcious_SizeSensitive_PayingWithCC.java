...
/**
 * @author Lata
 * Modified @test name and flow by Madhu
...
public class VEGASF_116_RegisteredUser_BrandConcious_SizeSensitive_PayingWithCC extends BaseIOSTest{
	...
	public void LoginWithEmail() throws InterruptedException, InvalidFileFormatException, IOException	{
		...
		System.out.println("=====================VEGASF_116_START=====================");
...
//		objHomePageObjects.clickOnHamburgerButton();don't remove commented lines(IN EVERY SCRIPT) till this issue got resolved(
//		objHamburgerPageObjects.clickOnMyAccount();
...
//
	...
	public void CheckPrice() throws InterruptedException	{
		Reporter.log("CheckPrice test case started successfully");
		System.out.println("CheckPrice Item!");
//		objPDPageObject.clickFirstProductSearchResult();
	...
	public void SelectSize_Qty() throws InterruptedException {
		...
		System.out.println("SelectSize_Qty Item!");
	...
	@Test(priority = 8)
	public void AddNewAddress_Ofice() throws InterruptedException, InvalidFileFormatException, IOException{
		Reporter.log("AddNewAddress test case started successfully");
		System.out.println("AddNewAddress Item!");
	...
	public void quit() {
		 ...
		 wd.quit();
		 System.out.println("=====================VEGASF_116_END=====================");
		}
