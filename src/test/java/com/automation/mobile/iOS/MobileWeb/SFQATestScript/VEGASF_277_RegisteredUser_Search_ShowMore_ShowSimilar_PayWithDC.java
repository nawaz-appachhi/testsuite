...
public class VEGASF_277_RegisteredUser_Search_ShowMore_ShowSimilar_PayWithDC extends BaseIOSTest{
	...
	public void LoginWithEmail() throws InterruptedException, InvalidFileFormatException, IOException	{
		...
		System.out.println("=====================VEGASF_277_START=====================");
...
//	@Test(priority = 5)
//	public void CheckSimilarProducts()	{
...
//}
	...
	public void PaymentWithEMI() throws InterruptedException	{
		...
		System.out.println("PaymentWithEMI!");
...
@AfterTest
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_277_END=====================");
	}
