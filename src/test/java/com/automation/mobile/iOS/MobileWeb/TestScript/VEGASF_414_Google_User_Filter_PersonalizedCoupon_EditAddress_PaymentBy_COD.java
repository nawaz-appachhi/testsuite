...
public class VEGASF_414_Google_User_Filter_PersonalizedCoupon_EditAddress_PaymentBy_COD extends BaseIOSTest{
	...
	public void LoginWithGoogle() throws InterruptedException, InvalidFileFormatException, IOException {
		...
		System.out.println("=====================VEGASF_414_START=====================");
...
//	@Test(priority = 7)
//	public void ApplyPersonalizedCoupons() throws InterruptedException, InvalidFileFormatException, IOException {
//		Reporter.log("ApplyPersonalizedCoupons test case started successfully");
//		System.out.println("Apply Personalized Coupons!");
...
//		objPaymentPageObjects.clickOnNetBanking();
	...
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_414_END=====================");
	}
