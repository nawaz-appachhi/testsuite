...
public class VEGASF_273_RegisteredUser_BrandProfile_BOGO_PayWithGiftCardAndCoD extends BaseIOSTest{
	...
	public void LoginWithEmail() throws InterruptedException, InvalidFileFormatException, IOException{
		...
		System.out.println("=====================VEGASF_273_START=====================");
...
//	}
	...
	@Test(priority = 5)
	public void CheckSizeLink() throws InterruptedException {
		Reporter.log("CheckSizeLink test case started successfully");
		System.out.println("CheckSizeLink!");
...
@AfterTest
	public void quit() {
		 ...
		 wd.quit();
		System.out.println("=====================VEGASF_273_END=====================");
	}
