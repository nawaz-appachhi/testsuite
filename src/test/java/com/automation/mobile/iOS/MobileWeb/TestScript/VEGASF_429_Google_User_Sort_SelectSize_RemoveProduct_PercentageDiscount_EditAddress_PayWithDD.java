 ...
 *         Shopper:
 * 
 *         Google registered user - Login Home Page Search (using menu item e.g.
 *         Men -> Topwear - T-Shirts Sort Verify Product Code View Size Chart
 *         Remove Product Percentage Discount Edit address Manual Payment : GC
 *         +Online
 */
...
public class VEGASF_429_Google_User_Sort_SelectSize_RemoveProduct_PercentageDiscount_EditAddress_PayWithDD extends BaseIOSTest{
	...
	public void LoginInMyntra() throws InterruptedException, InvalidFileFormatException, IOException {
		...
		System.out.println("=====================VEGASF_429_START=====================");
...
//		objPDPageObject.clickFirstProductSearchResult();
	...
	@Test(priority = 8)
	public void PaymentWithGC_Online() throws InterruptedException, InvalidFileFormatException, IOException {
		Reporter.log("PaymentWithGC_Online test case started successfully");
		System.out.println("Payment With GC_Online!");
