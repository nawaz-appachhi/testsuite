...
Similar Products
Size Chart
Move to wishlist  ( Deviation in flow instead of wishlist directly adding in to bag.)
Add New address - Office
Credit/Debit Card ( Card details are not entering as we get dummy data will be updating.)
 */
...
public class VEGASF_222_RegisteredUser_BrandConcious_NewAddress_PayWithDC extends BaseIOSTest{
