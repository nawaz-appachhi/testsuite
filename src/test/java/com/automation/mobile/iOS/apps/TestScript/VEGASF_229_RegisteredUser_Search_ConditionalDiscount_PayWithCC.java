...
Save
Move to bag
Contact Us (Not in the flow)
Conditional Discount ( Deviation in the flow due to test data)
View Details
Credit/Debit Card
 ...
 *
 */
public class VEGASF_229_RegisteredUser_Search_ConditionalDiscount_PayWithCC extends BaseIOSTest{
