...
public class VEGASF_226_RegisteredUser_BrandProfile_ShowMoreProducts_PayWithGiftCardAndCC extends BaseIOSTest{
	 ...
	 * Autosuggest - Brand Profile (Search for a brand like Nike, Roadster) Show
	 * More Products Save Move to bag Move to wishlist Apply Generic Coupons Edit
	 * address GIft card
	 * 
	 */
...
//		objPLPageObjets.clickOnFirstproductofPLP();
	...
	@Test(priority = 6)
	public void GiftCard() throws InterruptedException, InvalidFileFormatException, IOException {
