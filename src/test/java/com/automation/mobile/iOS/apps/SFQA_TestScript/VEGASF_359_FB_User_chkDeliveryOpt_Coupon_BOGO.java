 ...
 */
/*
 * Casual Browsing User Facebook registered user - Login Home Page Search -
 * Using Autosuggest (use any query from Golden Set) Sort by Discount Check
 * Delivery Option Move to bag Apply Coupon Buy One get One Add New address -
 * Home
 */

public class VEGASF_359_FB_User_chkDeliveryOpt_Coupon_BOGO extends BaseIOSTest{
...
//	}
	...
	public void productDiscriptionPage() throws InterruptedException, InvalidFileFormatException, IOException {
		...
		objPDPageObject.clickOnDeliveryOptionsList();
