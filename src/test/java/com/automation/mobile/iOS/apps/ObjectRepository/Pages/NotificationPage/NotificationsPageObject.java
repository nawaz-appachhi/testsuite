...
public class NotificationsPageObject {
	...
	public NotificationsPageObject(AppiumDriver<MobileElement> iDriver) {
	...
	public void clickOnNotifications() {
		objiOSGenericMethods.clickOnIOSElement(getNotifications(), "Notifications Button");
	}

	public void clickOnNotification() {
		objiOSGenericMethods.clickOnIOSElement(getNotification(), "Notification Button");

	}

	public void clickOnnAllowNotification() {
		objiOSGenericMethods.clickOnIOSElement(getAllowNotification(), "Allow Notification Button");
