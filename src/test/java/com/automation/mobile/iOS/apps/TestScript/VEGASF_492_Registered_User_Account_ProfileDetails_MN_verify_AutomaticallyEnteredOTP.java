...
# Account	
# Profile Details	
# Enter Phone Number(correct number)	
# Verify	
# Successfully Verified (Automatically)
 */

public class VEGASF_492_Registered_User_Account_ProfileDetails_MN_verify_AutomaticallyEnteredOTP extends BaseIOSTest{
	...
	public void beforeTest(@Optional("TD") String deviceName_, @Optional("TD") String UDID_,
		...
		objProfileSignUpPageObject = new ProfileSignUpPageObject(wd);
