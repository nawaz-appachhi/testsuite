 ...
 * 
 *         Test Data Pending Staggered Combo Manual GC +Online
 */

public class VEGASF_154_RegisteredUser_FilterStyles_StaggeredCombo_PayWith_CoD extends BaseAndroidTest {

	GlobalVariables objGlobalVariables;
	AppiumServer objAppiumServer;
	LoginPageObject objLoginPageObject;
	HomePageObject objHomePageObject;
	//AndroidDriver<AndroidElement> wd;
...
//		objCheckOutPageObject.resetAddress();
	...
	public void quit() {
		...
		wd.quit();
		System.out.println("=====================VEGASF_154_END=====================");
