 ...
 *
 */
public class VEGASF_459 extends BaseAndroidTest{
	...
	public void LoginWithFacebook() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_459_START=====================");
		Reporter.log("LoginInApp");
		objLoginPageObject.clickFirstLogin();
	/*	objLoginPageObject.clickFacebookbtn();
		objLoginPageObject.FacebookLogin(AndroidGenericMethods.getValueByKey(testName, "FacebookUserName"), AndroidGenericMethods.getValueByKey(testName, "FacebookPwd"));
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_459_END=====================");
	}
