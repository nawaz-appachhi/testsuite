 ...
 *
 */
public class VEGASF_478 extends BaseAndroidTest{
	...
	public void SignUp() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_478_START=====================");
		Reporter.log("LoginInApp");
		objLoginPageObject.clickFirstLogin();
		objLoginPageObject.loginInApp(AndroidGenericMethods.getValueByKey(testName, "UserName"),
				AndroidGenericMethods.getValueByKey(testName, "Password"));
		objLoginPageObject.clickLogin();//Need to be repalced with SignUp
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_478_END=====================");
	}
}
