 ...
 *
 */
public class VEGASF_458 extends BaseAndroidTest{
	...
	public void LoginWithGoogle() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_458_START=====================");
...
//		objLoginPageObject.clickOnUseAnotherAccount();
	 objLoginPageObject.EnterGmailEmail(AndroidGenericMethods.getValueByKey(testName, "GoogleUserName"));
		objLoginPageObject.AppEmailNextButton();
		objLoginPageObject.EnterGmailPassword(AndroidGenericMethods.getValueByKey(testName, "GooglePwd"));
		objLoginPageObject.AppPasswordNextButton();
		objLoginPageObject.clickOnAccept();
		objLoginPageObject.AppEmailNextButton();*/ //Google Login()
		objLoginPageObject.loginInApp(AndroidGenericMethods.getValueByKey(testName, "UserName") , AndroidGenericMethods.getValueByKey(testName,"Password"));
		objLoginPageObject.clickLogin();
		objLoginPageObject.giveAllPermissions();
//		objLoginPageObject.clickpopUp();
	...
	@Test(priority = 3)
	public void Profile() throws InvalidFileFormatException, IOException {
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_458_END=====================");
	}
