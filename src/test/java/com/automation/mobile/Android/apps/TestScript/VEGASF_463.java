 ...
 *
 */
public class VEGASF_463 extends BaseAndroidTest{
	...
	public void SignUpWithFacebook() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_463_START=====================");
		Reporter.log("LoginInApp");
		objLoginPageObject.clickFirstLogin();
		objLoginPageObject.loginInApp(AndroidGenericMethods.getValueByKey(testName, "UserName"),
				AndroidGenericMethods.getValueByKey(testName, "Password"));
		objLoginPageObject.clickLogin();//Code need to be replaced with signUpWith Facebook
...
//		objHamburgerPageObject.isVerified();
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_463_END=====================");
	}
}
