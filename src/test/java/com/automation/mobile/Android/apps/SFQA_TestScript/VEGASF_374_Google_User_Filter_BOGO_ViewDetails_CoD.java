 ...
 * Google registered user - Login Home , Page Search (by clicking banner or
 * nested banner on Home Page) ,Filter Products, Add to bag ,View Size Chart
 * ,Contact Us Buy One get One, View Details ,Payment : Online + LP
 * Pending LP,CheckForContactUs BuyOneGetOne 
 */
public class VEGASF_374_Google_User_Filter_BOGO_ViewDetails_CoD extends BaseAndroidTest {
...
//	@Test(priority = 2)
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_374_END=====================");
	}
