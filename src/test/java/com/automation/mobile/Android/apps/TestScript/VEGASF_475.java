 ...
 *
 */
public class VEGASF_475 extends BaseAndroidTest{
	...
	public void Login() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_475_START=====================");
	...
	@Test(priority = 6)
	public void AutoReadOtp() throws InvalidFileFormatException, IOException, InterruptedException {
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_475_END=====================");
	}
}
