 ...
 *
 */
public class VEGASF_473 extends BaseAndroidTest{
	...
	public void Login() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_473_START=====================");
	...
	public void resendOtp() throws InvalidFileFormatException, IOException {
		...
		objHamburgerPageObject.VerifyIncorrectOtpMsg();//uncomment only if able to enter otp
		objHamburgerPageObject.ClickOnResendOtp();
	}
	@Test(priority = 6)
	public void EnterOtp() throws InterruptedException, InvalidFileFormatException, IOException {
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_473_END=====================");
	}
}
