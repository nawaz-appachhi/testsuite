 ...
 *
 */
public class VEGASF_480 extends BaseAndroidTest{
	...
	public void SignUp() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_480_START=====================");
	...
	@Test(priority = 6)
	public void AutoReadOtp() throws InvalidFileFormatException, IOException {
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_480_END=====================");
	}
}
