 ...
 *
 */
public class VEGASF_468 extends BaseAndroidTest{
	...
	@Test(priority = 1)
	public void SignUpWithFacebook() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_468_START=====================");
		Reporter.log("LoginInApp");
		objLoginPageObject.clickFirstLogin();
		objLoginPageObject.loginInApp(AndroidGenericMethods.getValueByKey(testName, "UserName"),
				AndroidGenericMethods.getValueByKey(testName, "Password"));//Code need to repace with signUp with Facebook
	...
	@Test(priority = 5)
	public void enterCorrectPhoneNumber() throws InvalidFileFormatException, IOException {
		objHamburgerPageObject.enterPdPageMobileNumber(AndroidGenericMethods.getValueByKey(udidNumber, "MobileNumber"));
	}
	@Test(priority = 6)
	public void VerifyAutoDetectOtp() throws InvalidFileFormatException, IOException, InterruptedException {
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_468_END=====================");
	}
}
