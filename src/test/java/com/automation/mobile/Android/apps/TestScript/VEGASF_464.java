 ...
 *
 */
public class VEGASF_464 extends BaseAndroidTest{
	...
	@Test(priority = 1)
	public void SignUpWithGoogle() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_464_START=====================");
		Reporter.log("LoginInApp");
		objLoginPageObject.clickFirstLogin();
		objLoginPageObject.loginInApp(AndroidGenericMethods.getValueByKey(testName, "UserName"),
				AndroidGenericMethods.getValueByKey(testName, "Password"));//Code need to repace with signUp with google
	...
	public void enterIncorrectPhoneNumber() throws InvalidFileFormatException, IOException {
		objHamburgerPageObject.enterPdPageMobileNumber("9988776655");
	}
	@Test(priority = 6)
	public void Verify() throws InvalidFileFormatException, IOException {
		objHamburgerPageObject.clickPdPageVerifyBtn();
		objHamburgerPageObject.verifyTextMsgVerificationPage("9988776655");
		objHamburgerPageObject.EnterOtp("1234");
	}
	@Test(priority = 7)
	public void ResendOtp() throws InterruptedException, InvalidFileFormatException, IOException {
		objHamburgerPageObject.VerifyIncorrectOtpMsg();// uncomment if able to enter incorrect otp
	...
	try {
		...
		wd.quit();
	System.out.println("=====================VEGASF_464_END=====================");
	}
}
