...
//	Manual GC +Online
public class VEGASF_201_RegisteredUser_BrowseMenuItems_ClickForOffer_PayWithCoD extends BaseAndroidTest {
	 ...
	 * Reporter.log("SaveTo Wishlist test Started");
	 * objPLPageObjects.clickToSaveToWishlist();
	 * 
	 * }
	 * 
	 * @Test(priority = 5) public void NavigateFromPLPtoPDP() throws
	...
	@Test(priority = 12)
	public void CompletePayementGiftCard() throws InvalidFileFormatException, IOException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_201_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
