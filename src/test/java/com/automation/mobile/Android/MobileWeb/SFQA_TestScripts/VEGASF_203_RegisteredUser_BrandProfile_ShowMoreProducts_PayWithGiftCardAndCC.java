 ...
 */
public class VEGASF_203_RegisteredUser_BrandProfile_ShowMoreProducts_PayWithGiftCardAndCC extends BaseAndroidTest{
	...
	/*
	 * @Test(priority = 4) public void PLPToPDPNavigation() throws
	 * InterruptedException { Reporter.log("PLPToPDPNavigation tets Started");
