 ...
 *         Golden Set) 4. Click on a product from PLP and Navigate to PDP 5.Save
 *         the product to Wishlist from PDP 6. Select a size and add the product
 *         to Bag 7. Verify 'Contact us' link 8. Place the order from Bag page
 *         9. Add New Address for Delivery 10. Payment through Phonepe
 */
public class VEGASF_88_RegisteredUSer_AddNewAddress_PAymentWithGiftCardAndNetBanking extends BaseAndroidTest {
	...
	public void Login() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_88_START=====================");
	...
	@Test(priority = 8)
	public void AddNewOfficeAddress() throws InvalidFileFormatException, IOException {
	...
	@Test(priority = 9)
	public void PaymentByPhonePe() throws InterruptedException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_88_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
