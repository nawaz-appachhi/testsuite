 ...
 *         registered user - Login # Home Page # Search - Brand Profile (Search
 *         for a brand like Nike, Roadster) # Filter # Save to wishlist # Empty
 *         Wishlist # Gift wrap # Click for offer # Edit address # Payment :
 *         Online + LP
 */
public class VEGASF_355_Google_User_Filter_EmptyWishlist_GiftWrap_ClickforOffer_EditAddress_PayWithCoD
	...
	public void ApplyFilter() {
		...
		objFilterPageObjects.verifyFilterOptions();
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_355_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
