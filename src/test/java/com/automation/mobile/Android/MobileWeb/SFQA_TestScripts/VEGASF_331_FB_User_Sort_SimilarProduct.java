 ...
 */
public class VEGASF_331_FB_User_Sort_SimilarProduct {
	 ...
	 * "Password")); objAndroidGenericMethods.switchToMainWindow();
	 * objHambergerPageObjects.clickOnGoogle();
	 ...
	 * getValueByKeyWeb(testName,
	 * "UserName"),objAndroidGenericMethods.getValueByKeyWeb(testName,
	 * "Password")); objHambergerPageObjects.clickOnFacebookLoginButton();
