...
/**
 * @author 300019227 - Anu TEST STEPS Casual Browsing User # Google registered
 *         user - Login # Home Page # List page to PDP navigation # Top buttons
 *         # Check Delivery Option # Show Similar # Place Order # Apply
 *         Personalized Coupons # Add New address - Office # Payment :
 *         Credit/Debit Card
 */
public class VEGASF_353_FB_User_CheckDeliveryOption_ShowSimilar_ApplyPersonalizedCoupons_AddNewAddress_PayWithCC
	...
	@Test(priority = 4)
	public void ListPageToPDP() throws IOException {
	...
	@Test(priority = 8)
	public void ApplyGenericCoupons() throws InvalidFileFormatException, IOException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_353_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
