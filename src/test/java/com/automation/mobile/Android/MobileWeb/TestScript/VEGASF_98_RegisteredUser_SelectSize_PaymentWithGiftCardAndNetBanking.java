...
public class VEGASF_98_RegisteredUser_SelectSize_PaymentWithGiftCardAndNetBanking extends BaseAndroidTest {
	...
	/*
	 * @Test(priority = 4) public void PLP() throws InvalidFileFormatException,
	 * IOException { objPLPageObjects.getSearchResultHeader();
