...
public class VEGASF_214_RegisteredUser_BrowseMenu_ShowMore_AddMoreFromWishList_PayWithCoD extends BaseAndroidTest {
	...
	public void Login() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_214_START=====================");
	...
	@Test(priority = 6)
	public void AddFromWishlist() throws InterruptedException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_214_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
