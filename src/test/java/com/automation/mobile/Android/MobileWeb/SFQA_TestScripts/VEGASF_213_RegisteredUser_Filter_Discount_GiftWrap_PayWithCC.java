...
public class VEGASF_213_RegisteredUser_Filter_Discount_GiftWrap_PayWithCC extends BaseAndroidTest {
	...
	public void Login() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_213_START=====================");
	...
	/*
	 * @Test(priority = 4) public void Filter_Discount() throws InterruptedException
	 ...
	 * 
	 * @Test(priority = 6) public void ListPageToPDP() throws InterruptedException {
	...
	@Test(priority = 10)
	public void Offers() throws InterruptedException, InvalidFileFormatException, IOException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_213_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
