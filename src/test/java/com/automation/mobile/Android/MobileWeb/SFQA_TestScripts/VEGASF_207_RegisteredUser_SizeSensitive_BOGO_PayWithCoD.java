 ...
 *         Navigate from PLP to PDP 5. Select a size and Add the item to Bag 6.
 *         Verify 'Contact Us' page 7. Place the Order from Bag page 8. Add New
 *         Address and verify 'View Details' link 9. Payment through
 *         Credit/Debit card
 */
public class VEGASF_207_RegisteredUser_SizeSensitive_BOGO_PayWithCoD extends BaseAndroidTest {
	...
	public void LoginWithEmail() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_207_START=====================");
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_207_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
