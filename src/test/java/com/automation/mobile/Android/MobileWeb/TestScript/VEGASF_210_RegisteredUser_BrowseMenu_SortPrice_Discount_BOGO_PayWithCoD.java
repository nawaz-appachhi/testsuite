 ...
 *         -> Topwear - T-Shirts) and Sort with price 4. Navigate from PLP to
 *         PDP 5. Verify 'Size Chart' from PDP, Select a size and Add the item
 *         to Bag 6. Move the item to Wishlist from Bag Page 7. Move the item
 *         from Wishlist to Bag and Place the order 8. Add New Address and
 *         verify 'View Details' link 9. Payment through COD
 */
public class VEGASF_210_RegisteredUser_BrowseMenu_SortPrice_Discount_BOGO_PayWithCoD extends BaseAndroidTest {
	...
	public void LoginWithEmail() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_210_START=====================");
	...
	/*
	 * @Test(priority = 4) public void Sort_Discount() throws InterruptedException {
	 * 
	 * Reporter.log("Sort_Discount test Started");
	 * objFilterPageObjects.clickOnSortButton();
	 * objFilterPageObjects.clickOnpriceHightoLow(); }
	 * 
	 * @Test(priority = 5) public void FilterProducts() throws InterruptedException
	 * { Reporter.log("FilterProducts test Started");
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_210_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
