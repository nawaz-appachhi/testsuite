 ...
 *         5. Save the item from PDP, Apply Coupon, select a Size and Add the
 *         product to Bag 6. Move the item from Bag to Wishlist 7. Move the item
 *         from Wishlist to Bag and Place the order 8. Add New Address and Edit
 *         the address 9. Payment through Gift Card and Netbanking
 */
public class VEGASF_219_RegisteredUser_BOGO_PayWithGCAndCC extends BaseAndroidTest {
	...
	public void Login() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_219_START=====================");
	...
	/*
	 * @Test(priority = 4) public void Filter() throws InterruptedException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_219_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
