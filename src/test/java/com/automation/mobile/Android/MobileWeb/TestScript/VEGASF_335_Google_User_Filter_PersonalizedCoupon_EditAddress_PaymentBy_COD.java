...
/**
 * @author 300021278 -Rakesh TEST STEPS 1.Shopper # Google registered user _
 *         Login # Home Page # Search (using a keyword in the Golden Set) #
 *         Filter Products # Verify Product Code # Select Size from wishlist #
 *         Place Order # Apply Personalized Coupons # Edit address # Payment :
 *         Online + LP
 */
public class VEGASF_335_Google_User_Filter_PersonalizedCoupon_EditAddress_PaymentBy_COD extends BaseAndroidTest {
	...
	public void LoginInMyntra() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_335_START=====================");
	...
	@Test(priority = 7)
	public void coupon() throws InvalidFileFormatException, IOException {
		objAndroidGenericMethods.scrollDown(objBagPageObjects.getApplyCouponButton(), 50);
		// String coupon = objAndroidGenericMethods.getValueByKeyWeb(testName,
		// "Coupon");
	...
	@Test(priority = 10)
	public void PaymentLP_Online() throws InterruptedException {
		Reporter.log("PaymentLP_Online test started");
		objBagPageObjects.clickOnContinueButton();
		objBagPageObjects.assertPaymentPageTitle("payment");
		objPaymentPageObjects.VerifyDeliveryAddress();
		objAndroidGenericMethods.scrollDown(objPaymentPageObjects.netBanking, 10);
	}
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_335_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
