 ...
 *         Golden Set) 4. Navigate from PLP to PDP 5. Save the item from PDP,
 *         Apply Coupon, select a Size and Add the product to Bag 6. Move the
 *         item from Bag to Wishlist 7. Move the item from Wishlist to Bag and
 *         Place the order 8. Add New Address for Delivery 9. Payment through
 *         Netbanking
 */
public class VEGASF_217_RegisteredUser_Wishlist_Coupon_FreeGift_PayWithDC extends BaseAndroidTest {
	...
	public void Login() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_217_START=====================");
	...
	/*
	 * @Test(priority = 4) public void ListPageToPDP() throws InterruptedException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_217_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
