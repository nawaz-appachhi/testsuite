...
Home Page
List page to PDP navigation	Top buttons
Check Delivery Option	Move to bag
Contact Us
Staggered Combo
Edit address	Mynt+ Online
 */

public class VEGASF_98_RegisteredUser_SelectSize_PaymentWithGiftCardAndNetBanking {
	...
	/*@Test(priority = 4)
	public void PLP() throws InvalidFileFormatException, IOException {
		objPLPageObjects.getSearchResultHeader();
		objPDPageObject.clickFirstProductSearchResult();
	}*/

	@Test(priority = 5)
	public void CheckTopButton() throws InvalidFileFormatException, IOException {
	...
	@Test(priority = 7)
	public void CheckForDeliveryOption() throws InvalidFileFormatException, IOException {
	...
	@Test(priority = 8)
	public void StaggeredCombo() throws InvalidFileFormatException, IOException {
	...
	@Test(priority = 10)
	public void PaymentByMynt_Credit_Debit() {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_98_END=====================");
		aDriver.quit();
