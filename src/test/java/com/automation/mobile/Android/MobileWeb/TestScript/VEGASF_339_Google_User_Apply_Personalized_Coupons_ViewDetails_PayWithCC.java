 ...
 */
public class VEGASF_339_Google_User_Apply_Personalized_Coupons_ViewDetails_PayWithCC extends BaseAndroidTest {
	...
	public void LoginWithGoogle() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_339_START=====================");
		...
		// objHamburgerPageObjects.assertUserEmailID(objAndroidGenericMethods.getValueByKeyWeb(testName,
		// "UserName"));
		// wd.navigate().back();
	}
	...
	/*
	 * @Test(priority = 4) public void Sort() {
	...
	@Test(priority = 10)
	public void PaymentWithManualGC_Online() throws InvalidFileFormatException, IOException {
