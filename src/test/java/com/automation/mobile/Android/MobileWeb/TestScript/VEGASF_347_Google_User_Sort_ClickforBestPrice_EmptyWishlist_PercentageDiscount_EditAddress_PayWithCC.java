 ...
 */
public class VEGASF_347_Google_User_Sort_ClickforBestPrice_EmptyWishlist_PercentageDiscount_EditAddress_PayWithCC
	...
	public void LoginInMyntra() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_347_START=====================");
	...
	/*
	 * @Test(priority = 4) public void Sort() { Reporter.log("Sort");
	 * objFilterPageObjects.clickOnSortButton();
	 * objFilterPageObjects.clickOnPriceHightoLow(); }
	 * 
	 * @Test(priority = 5) public void FilterProducts() {
	...
	public void afterTest() {
		...
		wd.quit();
		System.out.println("=====================VEGASF_347_END=====================");
	}
}