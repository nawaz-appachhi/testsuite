...
public class VEGASF_118_RegisteredUser_PriceSensitive_UsesDiscountsCoupons_PayingWithCC extends BaseAndroidTest {
	...
	public void LoginWithEmail() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_118_START=====================");
	...
	public void BuyOneGetOne() throws InterruptedException {
		Reporter.log(" BuyOneGetOne test Started");
	...
	public void PaymentWithGC_Online() throws InvalidFileFormatException, IOException {
		...
		objAndroidGenericMethods.scrollDown(objPaymentPageObjects.changePaymentMode, -5);
