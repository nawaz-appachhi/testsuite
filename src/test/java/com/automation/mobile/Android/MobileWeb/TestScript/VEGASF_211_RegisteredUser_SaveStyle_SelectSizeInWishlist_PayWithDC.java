 ...
 *         Navigate from PLP to PDP 5. Save the product from PDP 6. Move the
 *         item to Bag from Wishlist 7. Verify 'Contact Us' page 8. Apply Coupon
 *         and Place the order from Bag page 9. Add New Address for Delivery 10.
 *         Payment through Netbanking
 */
public class VEGASF_211_RegisteredUser_SaveStyle_SelectSizeInWishlist_PayWithDC extends BaseAndroidTest {
	...
	public void LoginIn() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_211_START=====================");
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_211_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
