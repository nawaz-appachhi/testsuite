 ...
 *         Golden Set) 4. Navigate from PLP to PDP 5. Verify Similar Products
 *         Header from PDP, Select a size and Add the item to Bag 6. Send a Gift
...
public class VEGASF_208_RegisteredUser_Search_ShowMore_ShowSimilar_PayWithDC extends BaseAndroidTest{
	...
	public void LoginWithEmail() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_208_START=====================");
	...
	public void GiftWrap() throws InvalidFileFormatException, IOException {
		Reporter.log("AddGiftWrap test Started");
	...
	public void PlaceOrder() throws InterruptedException {
		...
		objBagPageObjects.verifyPriceDetails();
