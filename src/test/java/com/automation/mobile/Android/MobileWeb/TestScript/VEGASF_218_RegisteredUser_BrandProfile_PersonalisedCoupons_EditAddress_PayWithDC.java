...
/*Pending Apply Personalized Coupons,Saved Cards*/
/**
 * @author 300019225 - Amba
 */
public class VEGASF_218_RegisteredUser_BrandProfile_PersonalisedCoupons_EditAddress_PayWithDC extends BaseAndroidTest {
	...
	/*
	 * @Test(priority = 4) public void Filter() throws InvalidFileFormatException,
	...
	@Test(priority = 7)
	public void ApplyPersonalizedCoupons() throws InvalidFileFormatException, IOException {
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_218_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
