 ...
 */
public class VEGASF_346_FB_User_Filter_CheckDeliveryOption_AddMorefromWishlist_ClickforOffer_AddNewAddress_Office_PayWithCoD
	...
	/*
	 * @Test(priority = 3) public void Filter_Gender() {
	...
	@Test(priority = 8)
	public void PaymentWithMyntraCredit_COD() throws InvalidFileFormatException, IOException {
		objBagPageObjects.clickOnContinueButton();
		objBagPageObjects.assertPaymentPageTitle(objAndroidGenericMethods.getValueByKeyWeb(testName, "Payment"));
	...
	public void afterTest() {
		...
		wd.quit();
		System.out.println("=====================VEGASF_346_END=====================");
	}
}