 ...
 */
public class VEGASF_345_FB_User_CheckDeliveryOption_RemoveProduct_BOGO_AddNewAddress_Office_PayWithCC
	...
	public void LoginInMyntra() throws InterruptedException, InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_345_START=====================");
	...
	public void RemoveProduct() throws InterruptedException {
		Reporter.log("RemoveProduct");
		objHomePageObjects.clickOnBagIcon();
		objAndroidGenericMethods.scrollDown(objBagPageObjects.Removelink, 20);
	}
	...
	public void afterTest() {
		...
		wd.quit();
		System.out.println("=====================VEGASF_345_END=====================");
	}
}