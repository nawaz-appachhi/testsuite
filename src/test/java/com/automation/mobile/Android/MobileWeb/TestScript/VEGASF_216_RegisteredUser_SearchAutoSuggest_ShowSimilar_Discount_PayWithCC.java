 ...
 *         Golden Set) 4. Navigate from PLP to PDP and Verify 'Similar Products'
 *         header 5. Select a size and Add the item to Bag 6. Place the order
 *         from Bag page 7. Add New Address for Delivery 8. Payment through
 *         'Netbanking'
 */
public class VEGASF_216_RegisteredUser_SearchAutoSuggest_ShowSimilar_Discount_PayWithCC extends BaseAndroidTest {
	...
	public void LoginInApp() throws InvalidFileFormatException, IOException {
		System.out.println("=====================VEGASF_216_START=====================");
	...
	public void afterTest() {
		System.out.println("=====================VEGASF_216_END=====================");
		try {
			quitAppiumSession();
		} catch (Exception e) {
			// TODO Auto-generated catch block
