...
public class VEGASF_FreeGift extends GlobalVariables {
	...
	String testName = "VEGASF_FreeGift";
	...
	public void LoginInMyntra()  {
		System.out.println("=====================VEGASF_FreeGift_START=====================");
...
//		System.out.println("Verified Similar Products section");
	...
	public void AddToBagFromPDP()  {
		...
		objCartObject.VerifyGiftPrice();
		objCartObject.VerifyGiftText();
		objCartObject.VerifyFreeGiftFromCart();
		objCartObject.VerifyProductPrice();
		objCartObject.VerifyBagtotal();
		objCartObject.VerfiyTotalPrice();
		objCartObject.VerfiyProductIsAddedToCart();
	}
	...
	public void afterTest() {
		driver.quit();
		System.out.println("=====================VEGASF_FreeGift_END=======================");
	}
}
