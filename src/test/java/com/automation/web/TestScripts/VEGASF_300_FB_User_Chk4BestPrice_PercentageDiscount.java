 ...
 *
 */
public class VEGASF_300_FB_User_Chk4BestPrice_PercentageDiscount extends GlobalVariables {
...
//	}
	...
	public void Login()  {//Need to replace with Login with FaceBook
		System.out.println("=====================VEGASF_300_FB_User_Chk4BestPrice_PercentageDiscount_START=====================");
...
//	Commented as there is no Top Button present on plp page because of less products available
//	@Test(priority = 4)
...
//	}
	...
	public void afterTest() {
		...
		driver.quit();
		System.out.println("=====================VEGASF_300_FB_User_Chk4BestPrice_PercentageDiscount_END=======================");
	}
}
