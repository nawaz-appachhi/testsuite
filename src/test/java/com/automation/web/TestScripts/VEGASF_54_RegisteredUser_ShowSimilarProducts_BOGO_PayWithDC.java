...
public class VEGASF_54_RegisteredUser_ShowSimilarProducts_BOGO_PayWithDC extends GlobalVariables {
	...
	public void LoginInMyntra()  {
		System.out.println("=====================VEGASF_54_RegisteredUser_ShowSimilarProducts_BOGO_PayWithDC_START=====================");
...
//				objGenericMethods.getValueByKey(testName, "GiftCardPin"));
	...
	public void afterTest() {
		driver.quit();
		System.out.println("=====================VEGASF_54_RegisteredUser_ShowSimilarProducts_BOGO_PayWithDC_END=======================");
	}
}
