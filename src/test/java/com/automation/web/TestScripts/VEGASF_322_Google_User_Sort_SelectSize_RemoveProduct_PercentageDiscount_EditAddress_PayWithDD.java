...
/**
 * VEGASF-322 test for Shopper
 * Test steps for VEGASF-322:
 ...
 *
 */
public class VEGASF_322_Google_User_Sort_SelectSize_RemoveProduct_PercentageDiscount_EditAddress_PayWithDD extends GlobalVariables {
	...
	String testName="VEGASF_FF_322";
	
//	Change login mode - replace with google login
	@Test(priority = 1)
	public void LoginMyntra()  {
		System.out.println("=====================VEGASF_322_Google_User_Sort_SelectSize_RemoveProduct_PercentageDiscount_EditAddress_PayWithDD_START=====================");
...
//	}
	...
	public void EditAddress()  {
		...
		objAddressPageObjects.EditNameTextField("VegaSF322 " + objGenericMethods.datetime("ddMMyyyyHHmmss"));
		objAddressPageObjects.clickToSaveAddress();
		objAddressPageObjects.VerifyAddressAdded();
	}
...
//				objGenericMethods.getValueByKey(testName, "GiftCardPin"));
	...
	public void afterTest() {
		...
		driver.quit();
		System.out.println("=====================VEGASF_322_Google_User_Sort_SelectSize_RemoveProduct_PercentageDiscount_EditAddress_PayWithDD_END=======================");
	}
}
