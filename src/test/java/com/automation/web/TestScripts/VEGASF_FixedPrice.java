...
public class VEGASF_FixedPrice extends GlobalVariables {
	...
	String testName = "VEGASF_FixedPrice";
	...
	public void LoginInMyntra()  {
		System.out.println("=====================VEGASF_FixedPrice_START=====================");
...
//		System.out.println("Verified Similar Products section");
	...
	public void afterTest() {
		driver.quit();
		System.out.println("=====================VEGASF_FixedPrice_END=======================");
	}
}
