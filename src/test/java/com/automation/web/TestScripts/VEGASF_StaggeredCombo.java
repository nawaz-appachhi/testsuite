...
public class VEGASF_StaggeredCombo extends GlobalVariables {
	...
	String testName = "VEGASF_StaggeredCombo";
	...
	public void LoginInMyntra()  {
		System.out.println("=====================VEGASF_StaggeredCombo_START=====================");
...
//		System.out.println("Verified Similar Products section");
	...
	public void afterTest() {
		driver.quit();
		System.out.println("=====================VEGASF_StaggeredCombo_END=======================");
	}
}
