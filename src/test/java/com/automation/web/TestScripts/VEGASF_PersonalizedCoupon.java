...
public class VEGASF_PersonalizedCoupon extends GlobalVariables {
	...
	String testName = "VEGASF_PersonalizedCoupon";
	...
	public void LoginInMyntra()  {
		System.out.println("=====================VEGASF_PersonalizedCoupon_START=====================");
...
//		System.out.println("Verified Similar Products section");
	...
	public void afterTest() {
		driver.quit();
		System.out.println("=====================VEGASF_PersonalizedCoupon_END=======================");
	}
}
