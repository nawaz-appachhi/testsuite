...
public class VEGASF_COMBO_BOGO extends GlobalVariables {
	...
	String testName = "VEGASF_COMBO_BOGO";
	...
	public void LoginInMyntra()  {
		System.out.println("=====================VEGASF_COMBO_BOGO_START=====================");
...
//		System.out.println("Verified Similar Products section");
	...
	public void afterTest() {
		driver.quit();
		System.out.println("=====================VEGASF_COMBO_BOGO_END=======================");
	}
}
