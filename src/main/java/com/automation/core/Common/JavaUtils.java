...
public class JavaUtils {
	...
	public HashMap<String, String> readExcelData(String sheetname, String uniqueValue) {
		try {
			String key, value;
			FileInputStream file = new FileInputStream("./test-data/TestData.xlsx");
	...
	public void setGValueByKeyAndTitel(String title, String Key, String parameterName) throws IOException {
	 ...
	 * 
	 */
	public String getGValueByKey(String gettitle, String getKey) throws InvalidFileFormatException, IOException {
		Ini ini = new Ini(new File(System.getProperty("user.dir") + "//Configuration//Config.ini"));
