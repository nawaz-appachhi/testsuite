 ...
 * @author Abhijit.Pati
 */
public class BountyServiceHelperMT {
    static Initialize init = new Initialize("/Data/configuration");
    static Logger log = Logger.getLogger(BountyServiceHelperMT.class);
    ...
    public OrderResponse createOrder(CartEntry cartEntry, String ppsId, String login, String sessionId,
        ...
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.CREATE_ORDER_V2_MT,  null, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.POST, payload, BountyServiceHelperMT.getBountyHeader());
    ...
    public OrderCreationResponse queueOrder(String storeOrderId, String sessionId, String loginId,
        ...
        String payload = APIUtilities.getObjectToJSON(orderCreationRequestEntry);
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.QUEUE_ORDER_V2_MT,  null, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.POST, payload, BountyServiceHelperMT.getBountyHeader());
    ...
    public OrderCreationResponse confirmOnHoldOrder(String storeOrderId, String paymentStatus, String ppsID, boolean putOnHold) throws IOException {
        ...
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.CONFIRM_ORDER_V2_MT,  null, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.POST, payload, BountyServiceHelperMT.getBountyHeader());
        OrderCreationResponse orderCreationResponse = (OrderCreationResponse) APIUtilities.getJsontoObject(service.getResponseBody(), new OrderCreationResponse());
        return orderCreationResponse;
    }
    ...
    public OrderCreationResponse declineOrder(String storeOrderId, String login, String sessionID, String cartContext, String paymentStatus, long declineReasonId, boolean status) throws JAXBException, UnsupportedEncodingException {
        ...
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.DECLINE_ORDER_V2_MT,  null, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.POST, payload, BountyServiceHelperMT.getBountyHeaderXML());
    ...
    public OrderCreationResponse putOrderInHold(String storeOrderId, String paymentStatus) throws JAXBException, UnsupportedEncodingException {
        ...
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.PUT_ORDER_ONHOLD_MT,  null, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.POST, payload, BountyServiceHelperMT.getBountyHeaderXML());
        OrderCreationResponse orderCreationResponse = (OrderCreationResponse) APIUtilities.convertXMLStringToObject(service.getResponseBody(), new OrderCreationResponse());
        return orderCreationResponse;
    ...
    public OrderResponse getOrder(String orderID) throws JsonParseException, JsonMappingException, IOException {
        ...
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.GET_ORDER_V0_MT, new String[]{""+orderID}, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.GET, null, getBountyHeader());
    ...
    public OrderResponse getOrderByStoreOrderId(String storeOrderId) throws JsonParseException, JsonMappingException, IOException {
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.GET_ORDER_V0_MT, new String[]{""+storeOrderId}, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.GET, null, getBountyHeader());
        OrderResponse orderResponse = (OrderResponse) APIUtilities.getJsontoObject(service.getResponseBody(), new OrderResponse());
        org.testng.Assert.assertEquals(orderResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
        return orderResponse;
    ...
    public void pushOrderToOMS(String orderID) throws IOException {
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.PUSHORDERTOOMS_MT, new String[]{orderID}, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.GET, null, getBountyHeader());
        OrderResponse orderResponse = (OrderResponse) APIUtilities.getJsontoObject(service.getResponseBody(), new OrderResponse());
        org.testng.Assert.assertEquals(orderResponse.getStatus().getStatusType(), StatusResponse.Type.SUCCESS);
    }
    ...
    public void refreshBountyApplicationPropertyCache() throws IOException, JAXBException {
        Svc service = HttpExecutorService.executeHttpService(Constants.BOUNTY_PATH.REFRESHAPPLICATIONPROPERTIES_MT, null, SERVICE_TYPE.BOUNTY_SVC.toString(), HTTPMethods.GET, null, getBountyRefreshHeader());
