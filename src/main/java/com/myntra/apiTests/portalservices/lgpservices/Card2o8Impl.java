...
public class Card2o8Impl implements ILgpJsonKeys {
...
//				"$.props.image.link"
	...
	public String[] getOnBoardCustomFooterJsonPathsForCarousal() {
		 ...
		 String[] jsonPathListings = {
					...
					"$..children[#].type",
					"$..children[#].props",
					"$..children[#].props.links[0].link",
					"$..children[#].props.links[0].title",
					"$..children[#].props.links[0].type",
					"$..children[#].props.links[*]",
					"$..children[#].props.links[*].link",
					"$..children[#].props.links[*].title",
					"$..children[#].props.links[*].type",
	...
	public String[] getComponentsForArticleCard(String jsonResponse) {
		String[] jsonPathListings = {	
				...
				CardComponents.IMAGE_SINGLE.componentName
		};
		return jsonPathListings;
	}
	...
	public String[] getComponentsForPostStyleUpdateCard(String jsonResponse) {
		String[] jsonPathListings = {	
				...
				CardComponents.CREATOR_TITLE.componentName,
				CardComponents.FOOTER_LIKE_SHARE.componentName
		};
		return jsonPathListings;
	}
	...
	public String[] getComponentsForSplitBannerCard(String jsonResponse) {
		String[] jsonPathListings = {	
				...
				CardComponents.SPLIT_BANNER.componentName
		};
		return jsonPathListings;
	}
	...
	public String[] getComponentsForBudgetStoreCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getComponentsForEditProfileCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getComponentsForReferralCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getComponentsForSignupCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getComponentsForOutOfStockCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getComponentsForShotCarouselCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getComponentsForCustomProductCard(String jsonResponse) {
		String[] jsonPathListings = {	
	...
	public String[] getProductV2JsonPaths() {
		String[] jsonPathListings = {	
				...
				"$..children[#].props",
				"$..children[#].props.link",
				"$..children[#].props.images[0].src",
				"$..children[#].props.images[0].height",
				"$..children[#].props.images[0].width",
	...
	public String[] getSlideShowJsonPaths() {
		String[] jsonPathListings = {	
				...
				"$..children[#].type",
				"$..children[#].props",
				"$..children[#].props.slides[0].src",
				"$..children[#].props.slides[0].height",
				"$..children[#].props.slides[0].width",
				"$..children[#].props.slides[0].provider",
				"$..children[#].props.slides[0].alt",
				"$..children[#].props.slides[0].alt-h1",
				"$..children[#].props.slides[0].id",
				"$..children[#].props.slides[0].link",
