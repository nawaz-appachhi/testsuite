...
public class Card2o1Impl implements ILgpJsonKeys {
	...
	public String[] getBannerCardJsonPaths() {
		 ...
		 String[] jsonPathLinstings = {
				 ...
				 "$.cards[0].type",
				 "$.cards[0].props.id",
				 "$.cards[0].props.meta.og:app.id",
				 "$.cards[0].props.meta.og:url",
				 "$.cards[0].props.meta.og:image:url",
				 "$.cards[0].props.meta.share.og:url",
				 "$.cards[0].props.meta.share.og:image:url",
				 "$.cards[0].props.meta.share.og:title",
				 "$..children[0].type",
				 "$..children[0].props.image.src",
				 "$..children[0].props.link"
	...
	public String[] getSplitBannerCardJsonPaths() {
		...
		String[] jsonPathLinstings = {
				 ...
				 "$.cards[0].type",
				 "$.cards[0].props.id",
				 "$.cards[0].props.meta.og:name",
				 "$.cards[0].props.meta.og:app.id",
				 "$.cards[0].props.meta.og:title",
				 "$.cards[0].props.meta.og:url",
				 "$.cards[0].props.meta.og:image:url",
				 "$.cards[0].props.meta.share.og:image:url",
				 "$.cards[0].props.meta.share.og:url",
				 "$.cards[0].props.meta.share.og:title",
				 "$..children[0].type",
				 "$..children[0].props.splits[0].src",
				 "$..children[0].props.splits[0].id",
				 "$..children[0].props.splits[1].src",
				 "$..children[0].props.splits[1].id"
